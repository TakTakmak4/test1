...
def makeWaveObj(sidx, rkind, starttime, lat, lng):
    wobj = {"siteid":sidx, 
            "reisid":rkind, 
...
if __name__ == '__main__':
    ...
    wpbj1 = makeWaveObj(123,"reis1",starttime, 35.123,140.00)
    starttime = datetime.datetime.strptime("20181007102010", "%Y%m%d%H%M%S")
    wpbj2 = makeWaveObj(124,"reis1",starttime, 36.123,141.00)
    starttime = datetime.datetime.strptime("20181007102050", "%Y%m%d%H%M%S")
    wpbj3 = makeWaveObj(224,"reis2",starttime, 40.123,140.00)
